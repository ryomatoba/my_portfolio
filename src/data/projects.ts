  ...
  export const projectsData: Project[] = [ // 変数名を projectsData に変更（任意）
    {
      ...
      image: '/images/hackathon_thumbnail.png',
    ...
    },
    {
       ...
       image: '/images/intern-app-thumb.jpg',
    ...
    },
    {
       ...
       image: '/images/portfolio-site-thumb.png',
       tags: ['個人開発', 'React', 'TypeScript', 'TailwindCSS', 'Netlify'],
       githubUrl: 'https://github.com/ryomatoba/my_portfolio',
       longDescription: '自身のスキルや制作実績を紹介するために、React, TypeScript, Tailwind CSSを用いて開発したポートフォリオサイトです。Framer Motionによるアニメーション、ダークモード切り替え機能、レスポンシブデザインを実装し、Netlifyにデプロイしています。',
